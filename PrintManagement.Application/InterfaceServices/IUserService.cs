...
namespace PrintManagement.Application.InterfaceServices
{
    public interface IUserService
    {
        ...
        Task<ResponsePagedResult<DataResponseUser>> GetAllUsers(string? userName, int pageNumber, int pageSize);
        ...
        Task<ResponseObject<IEnumerable<DataResponseRole>>> GetRoleOfUser(int idUser);
        Task<ResponseObject<IEnumerable<DataResponseRole>>> GetAllRole();
    }
}
